...
$n2 = getString();
if (filter_var($n, FILTER_VALIDATE_INT) && filter_var($n1, FILTER_VALIDATE_INT)
    && filter_var($n2, FILTER_VALIDATE_INT)) {
    $a1 = array();
    $a2 = array();
    $a3 = array();
    ...
    echo "Enter the positive interger value to define the size \n";
}
