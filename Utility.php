...
function play()
{
    $str1 = array(array(), array());
    $str=store($str1);
    for ($i = 0; $i <= 8; $i++) {
        echo "User can select the box and put 'X' in the box \n";
        $r = getString();
        echo "Enter the symbol \n";
        $t = getString();
        Uturn($str, $r, $t);
        echo "Computer can select the box \n";
        $r = floor(rand(1, 9));
        $t = "0";
        UTurn($str, $r, $t);
    }
...
function UTurn($str, $r, $t)
{
    if ($r == 1 && $str[0][0] != "X" && $str[0][0] != "0") {
        $str[0][0] = $t;
    } else if ($r == 2 && $str[0][1] != "X" && $str[0][1] != "0") {
        $str[0][1] = $t;
    } else if ($r == 3 && $str[0][2] != "X" && $str[0][2] != "0") {
        $str[0][2] = $t;
    } else if ($r == 4 && $str[1][0] != "X" && $str[1][0] != "0") {
        $str[1][0] = $t;
    } else if ($r == 5 && $str[1][1] != "X" && $str[1][1] != "0") {
        $str[1][1] = $t;
    } else if ($r == 6 && $str[1][2] != "X" && $str[1][2] != "0") {
        $str[1][2] = $t;
    } else if ($r == 7 && $str[2][0] != "X" && str[2][0] != "0") {
        $str[2][0] = $t;
    } else if ($r == 8 && $str[2][1] != "X" && $str[2][1] != "0") {
        $str[2][1] = $t;
    } else if ($r == 9 && $str[2][2] != "X" && $str[2][2] != "0") {
        $str[2][2] = $t;
    }

}
function UserTurn($str, $r, $t, $i)
{
    $n = Uturn($str, $r, $t, $i);
    if ($n = -1) {
        $i--;
...
function ComputerTurn($str, $r, $t, $i)
{
    $n = Uturn($str, $r, $t, $i);
    if ($n = -1) {
        $i--;
